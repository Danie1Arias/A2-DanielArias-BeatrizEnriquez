# run.py (your script to call the TabuSearch class)

from TabuSearchAlgorithm import TabuSearch  # Assuming your code is saved as TabuSearchAlgorithm.py

# Example input data (replace with your actual job data)
...
# Create an instance of TabuSearch
tabu_search = TabuSearch(data3)

# Run the Tabu Search algorithm
best_solution, best_makespan, evolution, best_schedule = tabu_search.run()

# Output the results
print(f"Best Makespan: {best_makespan}")

# Plot the results (Evolution and Gantt Chart)
tabu_search.plot_results(evolution, best_schedule)
